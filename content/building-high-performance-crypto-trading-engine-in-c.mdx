...
summary: "Built high-frequency trading engine in C++ with sub-millisecond order execution (18.5μs latency), options strategies (covered calls, straddles), and backtesting. Achieved 54k orders/second throughput with StreamLit dashboard for real-time portfolio analytics."
type: "project"
...
[View on GitHub](https://github.com/arjunpkulkarni/crypto) | [Read Medium Article](https://medium.com/@arjunpkulkarni/crypto-trading-platform-in-c-67c842c6e991)
...
**Links:**
- [GitHub Repository](https://github.com/arjunpkulkarni/crypto)
- [Medium Article](https://medium.com/@arjunpkulkarni/crypto-trading-platform-in-c-67c842c6e991)
- [Documentation](https://github.com/arjunpkulkarni/crypto/blob/main/README.md)
